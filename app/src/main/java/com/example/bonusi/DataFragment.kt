...
class DataFragment() : Fragment(), Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<DataFragment> {
        override fun createFromParcel(parcel: Parcel): DataFragment {
            return DataFragment(parcel)
        }

        override fun newArray(size: Int): Array<DataFragment?> {
